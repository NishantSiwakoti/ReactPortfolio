...
const Contact = ({ title, setProgress }) => {
  ...
  return (
    <div className="my-6">
      <div className="max-w-6xl mx-auto bg-white  dark:bg-slate-800">
        <div className="grid md:grid-cols-2 items-center gap-16 sm:p-10 p-4 font-[sans-serif]">
          <div data-aos="fade-right">
            ...
            <ul className="flex mt-12 space-x-4">
              <li className="bg-[#f97316] hover:bg-orange-700 h-10 w-10 rounded-full flex items-center justify-center shrink-0">
          ...
          >
            ...
            <form className="mt-8 space-y-4">
              <input
                type="text"
                placeholder="Name"
                className="w-full rounded-md py-3 px-4 text-sm outline-[#f97316]"
              />
              <input
                type="email"
                placeholder="Email"
              ...
              <textarea
                placeholder="Message"
                rows="6"
                className="w-full rounded-md px-4 text-sm pt-3 outline-[#f97316]"
              ></textarea>
              <button
                type="button"
                className="text-white bg-[#f97316] hover:bg-orange-600 font-semibold rounded-md text-sm px-4 py-3 flex items-center justify-center w-full"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16px"
