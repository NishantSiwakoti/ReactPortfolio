      ...
      <div className="flex items-center justify-center py-6 px-4">
        <div className="bg-gray-300 shadow-lg rounded-lg overflow-hidden w-full max-w-4xl transform hover:scale-105 transition-transform duration-300">
          <div className="grid grid-cols-1 md:grid-cols-3 items-center">
            <div className="flex flex-col items-center p-2 bg-gradient-to-b from-yellow-400 to-yellow-600">
              <img
                src={props.photo1}
                alt="Team 1 Logo"
                className="h-16 w-16 md:h-20 md:w-20 object-contain mb-2 rounded"
              />
              <span className="text-md md:text-lg font-semibold text-white truncate">
                {props.team1}
              </span>
            </div>
              ...
              <div>
                {buttonText === "Live" ? (
                  ...
                  <button
                    ...
                    disabled
                    className="px-4 py-1 rounded-full text-md font-medium text-white"
                  >
                    {countdown}
                  </button>
                ) : (
