  ...
  return (
    isDivVisible && (
      <div className="flex items-center justify-center py-8">
        <div className="bg-gradient-to-r from-purple-400 via-purple-500 to-purple-600 shadow-lg rounded-lg overflow-hidden w-full max-w-4xl transition-transform transform hover:scale-105">
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/3 flex flex-col items-center p-4">
              <img
                src={props.photo1}
                alt=""
                className="h-20 w-20 md:h-28 md:w-28 rounded-3xl object-contain mb-2"
              />
            ...
            <div className="md:w-1/3 flex flex-col items-center p-4">
              <img
                src={props.photo2}
                alt=""
                className="h-20 w-20 rounded-3xl md:h-28 md:w-28 object-contain mb-2"
              />
              <span className="text-lg md:text-xl font-semibold text-white truncate">
                {props.team2}
              </span>
